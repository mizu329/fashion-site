...
fugiat nulla
                ...
                <p className="text-sm leading-relaxed text-left">山路を登りながら、こう考えた。智に働けば角が立つ。情に棹させば流される。意地を通せば窮屈だ。とかくに人の世は住みにくい。住みにくさが高じると、安い所へ引き越したくなる。</p>
...
<div className="mb-10 text-right">
 ...
 {/* 背景の円形装飾 */}
              ...
              {/* メインの円形画像（擬似） */}
              <div className="relative z-10 ml-auto h-[650px] w-[650px] rounded-full bg-gradient-to-br from-white/60 to-white/20 shadow-2xl" />
