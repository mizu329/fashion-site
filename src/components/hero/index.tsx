    ...
    <>
      ...
      <section className="relative flex flex-1 flex-col gap-10 overflow-hidden px-10 pb-24 pt-6">
        ...
        <div className="mt-10 grid grid-cols-3 gap-6">
          <div className="aspect-4/5 rounded-3xl bg-linear-to-b from-[#acd0f4] to-[#7b9fcc]" />
          <div className="aspect-4/5 rounded-3xl bg-linear-to-b from-[#f4d6e2] to-[#e6a9c4]" />
          <div className="aspect-4/5 rounded-3xl bg-linear-to-b from-[#d7f0da] to-[#9fd7ab]" />
        </div>
